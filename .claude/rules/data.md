...
Submission facts come from the exact hash in `/jobs/{uuid}/submissions`: bounded cleaned reply,
failureReason, usage, failed-check names, findings count and artifact name/bytes. Non-oracle rows
