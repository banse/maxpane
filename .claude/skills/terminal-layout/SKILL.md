...
| surf `a` agent (hero, seat and node card rows on one column grid, RECORD; re-swept 2026-09-22 for the grid) | 139 cols · 33 rows; RECORD clears at 167 (165 before panel/tok, 2026-09-23; 204 until launch/sub left it, 2026-09-22) | `screens/surf.SURF_AGENT_FULL_LAYOUT_{COLUMNS,ROWS}`, `RECORD_NEVER_CLEARS_BELOW` |
