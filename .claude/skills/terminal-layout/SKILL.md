...
| surf `a` agent (hint `a agent`, since 2026-09-21; re-swept the same day for the lifetime `/seats` record, unchanged) | 134 cols · 40 rows | `screens/surf.SURF_AGENT_FULL_LAYOUT_{COLUMNS,ROWS}` |
