...
| `widgets/surf/pool4_*.py` | `widgets/surf/_fmt.py`, `widgets/rowfit.py`, `widgets/markup_safety.py`, `widgets/sparkline_common.py` | `data/`, `analytics/` (no pool4 widget needs an analytics module; the allowlist stays at `analytics.surf_feed`) |
