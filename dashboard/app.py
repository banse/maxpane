...
from dashboard.data.base_manager import BaseManager
from dashboard.data.frenpet_manager import FrenPetManager
from dashboard.data.manager import DataManager
from dashboard.screens.bakery import BakeryScreen
from dashboard.screens.base_terminal import BaseTerminalScreen
from dashboard.screens.frenpet import FrenPetScreen
from dashboard.screens.game_select import GameSelectScreen
from dashboard.screens.splash import SplashScreen
from dashboard.themes import THEMES, THEME_NAMES
...
class MaxPaneApp(App):
    ...
    _GAME_CYCLE = ["bakery", "frenpet", "base"]
