...
def _sample_data() -> dict:
    ...
    data = {
        ...
        #
        # A healthy, mid-flight moment: some agents on shift, two jobs
        # executing, one service degraded -- deliberately not an all-quiet
        ...
        # `data/surf_swarm.throughput_facts`'s shape (swarm v2 plan §1.3):
        # a two-day window of nine jobs, three of them timed, one cancel.
        "swarm_throughput": {
            "window_start_ts": _TS_POST_13 - 2 * 86_400.0,
            "window_end_ts": _TS_POST_13 - 120.0,
            "window_n": 9,
            "states": [{"state": "completed", "count": 6},
                       {"state": "executing", "count": 2},
                       {"state": "cancelled", "count": 1}],
            "dur_median_s": 5_400.0, "dur_p90_s": 9_000.0, "dur_max_s": 9_600.0,
            "dur_n": 3,
            "cancel_reasons": [{"reason": "superseded", "count": 1}],
            "completed_24h": 4,
            "seen_since_ts": _TS_POST_13 - 86_400.0,
        },
        ...
        **swarm_agent_sources(1548),
        ...
        "swarm_seat_work_rows": [
            {"job_id": "job-4402", "node_key": "codex-14", "role": "implement",
             ...
             "answer": "Updated the link.", "answer_state": "read", "model": "gpt-6-astra", "took_s": 38,
             "output_tokens": 812, "panel_state": "not_oracle", "panel_agreed": None,
             "panel_quorum": None, "panel_size": None, "panel_figure": None,
             "panel_answer_type": None, "panel_answer_bool": None,
            ...
            {"job_id": "00000000-0000-4000-8000-000000000001", "node_key": "oracle_assess", "role": "assess",
             "job_state": "completed", "work_status": "accepted",
             "objective": "Report the observed value",
             "accepted_ts": _TS_POST_13 - 4_200.0, "submitted_ts": _TS_POST_13 - 4_300.0,
             "launch": None, "submission_hash": "cd"*32,
             "answer": "457162630000000001", "answer_state": "read", "model": "claude-sonnet-5", "took_s": 72,
             "output_tokens": 1534, "panel_state": "agreed", "panel_agreed": 4,
             "panel_quorum": 5, "panel_size": 5, "panel_figure": "457162630000000001",
             "panel_answer_type": "uint256", "panel_answer_bool": None,
             "oracle_question": "What is the value in wei?", "oracle_chain_id": 1,
             "oracle_member_ok": True, "oracle_member_reason": None,
             "oracle_seat_answer": "457162630000000001", "oracle_notes": "Observed at the pinned block."},
            {"job_id": "00000000-0000-4000-8000-000000000002", "node_key": "oracle_assess", "role": "assess",
             "job_state": "completed", "work_status": "rejected",
             "objective": "Check the statement",
             "accepted_ts": None, "submitted_ts": _TS_POST_13 - 4_500.0,
             "launch": None, "submission_hash": "ef"*32,
             "answer": "YES", "answer_state": "read", "model": "gpt-6-astra", "took_s": 51,
             "output_tokens": 999, "panel_state": "outvoted", "panel_agreed": 4,
             "panel_quorum": 5, "panel_size": 5, "panel_figure": None,
             "panel_answer_type": "bool", "panel_answer_bool": False,
             "oracle_question": "Is the statement true?", "oracle_chain_id": 1,
             "oracle_member_ok": True, "oracle_member_reason": None,
             "oracle_seat_answer": "true", "oracle_notes": "Source checked; the panel disagreed."},
            {"job_id": "00000000-0000-4000-8000-000000000003", "node_key": "oracle_assess", "role": "assess",
             "job_state": "completed", "work_status": "accepted", "objective": "List the contracts",
             "accepted_ts": _TS_POST_13-4600, "submitted_ts": _TS_POST_13-4700,
             "launch": None, "submission_hash": "12"*32, "answer": "Created answer.json.",
             "answer_state": "read", "model": "gpt-6-astra", "took_s": 42, "output_tokens": 2100,
             "panel_state": "agreed", "panel_agreed": 4, "panel_quorum": 4, "panel_size": 5,
             "panel_figure": None, "panel_answer_type": "address[]", "panel_answer_bool": None,
             "oracle_question": "Which contracts match?", "oracle_chain_id": 4663,
             "oracle_member_ok": True, "oracle_member_reason": None,
             "oracle_seat_answer": "0x"+"1"*40, "oracle_notes": "The matching contract was verified."},
        ],
    ...
    data['swarm_seat_work_rows'].extend([
        dict(source, job_id='7b9c907d-99b9-405b-8491-6088c77d4cc9', submission_hash='34'*32,
            ...
            job_read='read', job_read_ts=_AS_OF, job_detail_state='blocked', job_blocked_reason='node hunt_b: runtime_error',
        ...
        dict(source, job_id='00000000-0000-4000-8000-000000000005', submission_hash='78'*32,
            ...
            job_read='read', job_read_ts=_AS_OF, job_detail_state='completed', job_nodes=[]),
    ])
    return data
